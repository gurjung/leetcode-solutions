...
var trap = function (arr) {
    ...
    // left and right pointer track max seen so far on left and right
    // whichever is smaller will add to total
    ...
    while (left < right) {
        ...
        if (maxL < maxR) {
            total = total + maxL - arr[left];
            left++;
        } else {
            total = total + maxR - arr[right];
            right--;
        }
    }
